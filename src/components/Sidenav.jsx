...
import {AiOutlineContacts, AiOutlineHome, AiOutlineMail, AiOutlineMenu, AiOutlineProject} from 'react-icons/ai'
...
function Sidenav() {
  ...
  return (
    <div>
        <AiOutlineMenu onClick={handleNav}className=' absolute top-4 right-4 z-[99] md:hidden'style={{color:'white'}}/>
        {
            nav?(
